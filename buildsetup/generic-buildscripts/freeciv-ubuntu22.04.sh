...
# "> chmod +x freeciv-ubuntu22.04.sh"
# Run the script, e.g.
# "> ./freeciv-ubuntu22.04.sh --help"
# or
# "> ./freeciv-ubuntu22.04.sh 3.0.3 gtk3.22"
# or
# "> ./freeciv-ubuntu22.04.sh 3.0.3 qt"
# or
# "> ./freeciv-ubuntu22.04.sh 3.0.3 sdl2"
#

if test "$1" = "-v" || test "$1" = "--version" ; then
  echo "Freeciv build script for Ubuntu-22.04 (jammy) version 1.07"
  exit
fi
